...
const RadarSweepRingMaterialSource = `
...
class RadarSweepRingMaterial {
  constructor(options = {}) {
    this._definitionChanged = new Cesium.Event();
    // 唯一材质类型名，避免冲突
    this._type = 'MyRadarSweepRingMaterial'
  ...
  _registerMaterial() {
    ...
    Cesium.Material._materialCache.addMaterial(type, {
      fabric: {
        ...
        source: RadarSweepRingMaterialSource
      },
      translucent: true,
    });
  }
  ...
  equals(other) {
    return this === other || (other instanceof RadarSweepRingMaterial && other._type === this._type);
  }
  // 响应式设置方法
  setColor(color) {
...
export default RadarSweepRingMaterial;